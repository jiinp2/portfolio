...
function Work() {
  ...
  return (
    <div className={`grid grid-cols-[minmax(320px,380px)_1fr] h-screen w-screen transition-[grid-template-columns] duration-[800ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:grid-cols-1 max-md:grid-rows-[auto_auto] max-md:h-auto ${
      ...
      <aside className={`bg-white p-16 border-r border-gray-100 h-auto overflow-y-auto overflow-x-hidden [scrollbar-gutter:stable] transition-[background-color,border-color,color] duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:relative max-md:w-screen max-md:min-h-auto max-md:h-auto max-md:p-8 max-md:border-r-0 max-md:border-b max-md:border-b-gray-100 max-md:order-1 max-md:overflow-visible max-md:overflow-y-visible max-md:[scrollbar-gutter:auto] max-sm:p-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-sm hover:[&::-webkit-scrollbar-thumb]:bg-gray-200 ${
        ...
        <div className="w-full max-md:max-w-none max-md:text-left">
          {/* INTRO */}
          <div className="mb-8">
            <Link to="/misc" className="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mb-6 overflow-hidden cursor-pointer no-underline transition-transform duration-[900ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-[1.02]">
              <img
      ...
      <main className={`overflow-y-auto h-screen p-16 w-full bg-[#fcfcfc] transition-[background-color,color] duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:ml-0 max-md:h-auto max-md:p-8 max-md:order-2 max-sm:p-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-sm hover:[&::-webkit-scrollbar-thumb]:bg-gray-200`}>
        <div className="mb-8 flex flex-col gap-6">
          <div className="flex items-center gap-2">
            <Link to="/misc" className="no-underline cursor-pointer transition-all duration-200 hover:[&_h2]:text-gray-500">
              <h2 className="text-2xl font-medium text-text tracking-tight leading-tight m-0 transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:text-xl max-sm:text-xl">Work</h2>
            </Link>
            <Link to="/misc" className="inline-flex items-center no-underline cursor-pointer transition-all duration-200 group">
