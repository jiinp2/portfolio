...
function Misc() {
  ...
  return (
    <div className={`grid grid-cols-[minmax(320px,380px)_1fr] h-screen w-screen transition-[grid-template-columns] duration-[800ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:grid-cols-1 max-md:grid-rows-[auto_auto] max-md:h-auto ${isDarkMode ? 'dark-mode' : ''} ${
      isCaseStudyOpen ? "grid-cols-1" : ""
    }`}>
      {/* Left Column - About Me Section */}
      <aside className={`bg-white p-16 border-r border-gray-100 h-auto overflow-y-auto overflow-x-hidden [scrollbar-gutter:stable] transition-[background-color,border-color,color] duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:relative max-md:w-screen max-md:min-h-auto max-md:h-auto max-md:p-8 max-md:border-r-0 max-md:border-b max-md:border-b-gray-100 max-md:order-1 max-md:overflow-visible max-md:overflow-y-visible max-md:[scrollbar-gutter:auto] max-sm:p-6 ${!isDarkMode ? '[&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-sm hover:[&::-webkit-scrollbar-thumb]:bg-gray-200' : ''} ${
        isCaseStudyOpen ? "max-md:transform max-md:-translate-x-full max-md:opacity-0 max-md:transition-[transform,opacity] max-md:duration-[800ms] max-md:ease-[cubic-bezier(0.4,0,0.2,1)]" : ""
      }`}>
        <div className="w-full max-md:max-w-none max-md:text-left">
          {/* INTRO */}
          <div className="mb-8">
            <Link to="/" className="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mb-6 overflow-hidden cursor-pointer no-underline transition-transform duration-[900ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-[1.02]">
              <img src="/home/jiin_ac.png" alt="Jiin Park" className="w-full h-full object-cover rounded-full" />
            </Link>
            ...
            <p className="text-lg text-text-light mb-8 font-normal transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:text-lg max-md:mb-8 max-sm:text-base">Product Designer <br /> + Design Engineer</p>
          </div>
          
          {/* ABOUT TEXT */}
          <div className="mb-10 max-md:mb-8">
            <p className="text-base text-text-muted leading-relaxed mb-4 transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] last:mb-0 max-md:text-base max-sm:text-sm">
          ...
          <div className="flex gap-2 flex-wrap mb-10 max-md:mb-8">
            ...
            <a 
              ...
              rel="noopener noreferrer"
            >
              <img src="/home/linkedin.png" alt="LinkedIn" className="w-4 h-4 flex-shrink-0 object-contain" />
              LinkedIn
            </a>
            <a 
              ...
              rel="noopener noreferrer"
            >
              <img src="/home/github.png" alt="GitHub" className="w-4 h-4 flex-shrink-0 object-contain" />
              GitHub
            </a>
          </div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-start max-md:gap-2">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <div className="text-base font-medium text-text transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">Design Engineer</div>
                    ...
                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-start max-md:gap-2">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <div className="text-base font-medium text-text transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">Product Designer</div>
                    ...
                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-start max-md:gap-2">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <div className="text-base font-medium text-text transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">UI Design & UX Research Intern</div>
                ...
                <div className="mb-10 last:mb-0 max-md:gap-2">
                  <div className="flex flex-col gap-4">
                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-start max-md:gap-2">
                      <span className="text-sm text-text-light font-normal transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">2025</span>
                      <div className="flex flex-col gap-0.5">
                        <div className="text-base font-medium text-text transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">Software Engineering</div>
                        <div className="text-sm text-text-light font-normal transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">BrainStation</div>
                      </div>
                    </div>
                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-start max-md:gap-2">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <div className="text-base font-medium text-text transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">Design System</div>
                    ...
                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-start max-md:gap-2">
                      <span className="text-sm text-text-light font-normal transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">2021</span>
                      <div className="flex flex-col gap-0.5">
                        <div className="text-base font-medium text-text transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)]">Industrial Design</div>
      ...
      <main className={`overflow-y-auto h-screen p-16 w-full bg-[#fcfcfc] transition-[background-color,color] duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:ml-0 max-md:h-auto max-md:p-8 max-md:order-2 max-sm:p-6 ${!isDarkMode ? '[&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-100 [&::-webkit-scrollbar-thumb]:rounded-sm hover:[&::-webkit-scrollbar-thumb]:bg-gray-200' : ''}`}>
        <div className="mb-8 flex flex-col gap-6">
          <div className="flex items-center gap-2">
            <Link to="/" className="no-underline cursor-pointer transition-all duration-200 hover:[&_h2]:text-gray-500">
              <h2 className="text-2xl font-medium text-text tracking-tight leading-tight m-0 transition-colors duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] max-md:text-xl max-sm:text-xl">Misc</h2>
            </Link>
            <Link to="/" className="inline-flex items-center no-underline cursor-pointer transition-all duration-200 group">
              <ArrowLeftRight className="text-primary inline-flex items-center leading-none transition-all duration-[900ms] ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:text-primary-hover group-hover:scale-x-[-1]" size={20} />
            </Link>
          </div>
